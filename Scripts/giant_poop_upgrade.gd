...
func _on_upgrade_giant_poop_button_pressed():
	...
	if (upgrades_left == 3) and (Globals.poop_amount >= 500):
		...
		upgrades_left = 2
		Globals.giant_poop_upgrade_minimum = 4
		Globals.giant_poop_upgrade_maximum = 6
		...
		upgrades_left = 1
		Globals.giant_poop_upgrade_minimum = 5
		Globals.giant_poop_upgrade_maximum = 8
		Globals.upgrade_guinea_id = guinea_id
		upgrade_purchased.emit()
		_update_upgrade_information()
		_update_upgrade_dictionary()
		...
		upgrades_left = 0
		Globals.giant_poop_upgrade_minimum = 6
		Globals.giant_poop_upgrade_maximum = 10
		Globals.upgrade_guinea_id = guinea_id
		upgrade_purchased.emit()
		_update_upgrade_information()
		_update_upgrade_dictionary()
